...
class Part extends MWObject {
   ...
   public static final Color PARTS_COLOR = Color.yellow;
   ...
   Part(int x, int y, int basewidth, int width_numerator, int width_denominator, int baseheight, int height_numerator, int height_denominator) {
      super(x, y);
      this.x = x;
      this.y = y;
   ...
   public MWObject copy() {
      Part p = new Part(this.x, this.y, this.width, this.height);
